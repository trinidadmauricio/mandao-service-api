...
describe('AssignDriverUseCase', () => {
  ...
  it('should assign driver to order as SUPERVISOR with same provider', async () => {
    const order = new Order(
      'order-id',
      'tenant-id',
      BigInt(1),
  ...
  it('should throw error if SUPERVISOR tries to assign driver from different provider', async () => {
    const order = new Order(
      'order-id',
      'tenant-id',
      BigInt(1),
  ...
  it('should throw error if SUPERVISOR tries to assign to order from different provider', async () => {
    const order = new Order(
      'order-id',
      'tenant-id',
      BigInt(1),
